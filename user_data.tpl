...
LB_HOSTNAME="${LB_HOSTNAME}"
 ...
 yum repolist
 yum update -y
 yum install -y php-pear httpd mysql php php-devel php-mysqlnd gcc-c++ php-opcache make wget


 mkdir -p /var/www/wordpress
 mount -t nfs4 -o nfsvers=4.1,rsize=1048576,wsize=1048576,hard,timeo=600,retrans=2,noresvport $EFS_MOUNT:/ efs /var/www/wordpress
...
## install cache client
 ...
 cp 'AmazonElastiCacheClusterClient-1.0.0/amazon-elasticache-cluster-client.so' /usr/lib64/php/modules/
